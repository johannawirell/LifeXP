...
export const goalsScreenStyles = StyleSheet.create({
  ...
  content: { paddingBottom: 120, paddingHorizontal: 16, paddingTop: 6 },
  ...
  filterRow: { gap: 16, paddingBottom: 8, paddingTop: 2 },
  ...
  sectionTitle: { color: '#F5F7FB', fontSize: 20, fontWeight: '800', marginBottom: 8, marginTop: 6 },
  overviewCard: {
